...
const style = {
  ...
  btnContainer:
    "mx-auto transition duration-[250ms] font-normal cursor-pointer hover:opacity-[0.9] my-2 flex items-center justify-center bg-neutral-600  px-4 rounded-lg w-[100%] md:w-[70%] mx-auto",
      ...
      <form className={style.formContainer}>
        ...
        {isError && (
          <p className=" my-4 [100%] md:w-[70%] mx-auto font bg-red-600 text-white p-4 text-center w-[100%] rounded-lg">
            Please fill out correct details
          </p>
        )}
